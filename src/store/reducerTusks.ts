...
import {v1} from "uuid";
import {AddTodoListACType} from "./reducerTodoLists";
...
type AllACTypes = RemoveTaskACType | ChangeTaskTitleACType | AddTaskACType | ChangeTaskStatusACType | AddTodoListACType;
